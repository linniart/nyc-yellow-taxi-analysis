...
output dataset name = no_of_trips_by_route.csv*/
...
SELECT 
    pickup_borough,pickup_zone_name,route_borough, route_zone_name, COUNT(*) as no_trips
FROM t2
GROUP BY pickup_borough,pickup_zone_name,route_borough,route_zone_name
ORDER BY pickup_borough ASC,no_trips DESC
