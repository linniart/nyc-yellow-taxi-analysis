...
output dataset name = trend.csv and trend_radial_data.csv*/
...
SELECT 
    pickup_borough, pickup_date, pickup_weekday_name, pickup_hour, COUNT(*) no_of_trips
FROM t2
GROUP BY pickup_date, pickup_weekday_name, pickup_borough, pickup_hour
